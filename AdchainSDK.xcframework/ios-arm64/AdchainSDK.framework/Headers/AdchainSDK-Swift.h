...
SWIFT_CLASS_NAMED("AdchainSDKObjCBridge")
@interface AdchainSDKObjCBridge : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AdchainSDKObjCBridge * _Nonnull shared;)
+ (AdchainSDKObjCBridge * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (void)initializeSDKWithApplication:(UIApplication * _Nonnull)application appKey:(NSString * _Nonnull)appKey appSecret:(NSString * _Nonnull)appSecret completion:(void (^ _Nonnull)(BOOL, NSString * _Nullable))completion;
- (void)loginWithUserId:(NSString * _Nonnull)userId gender:(NSString * _Nullable)gender birthYear:(NSNumber * _Nullable)birthYear completion:(void (^ _Nonnull)(BOOL, NSString * _Nullable))completion;
- (BOOL)isLoggedIn SWIFT_WARN_UNUSED_RESULT;
- (void)loadQuizWithUnitId:(NSString * _Nonnull)unitId completion:(void (^ _Nonnull)(BOOL, NSArray * _Nullable))completion;
- (void)showOfferwallFrom:(UIViewController * _Nonnull)viewController completion:(void (^ _Nonnull)(BOOL, NSString * _Nullable))completion;
