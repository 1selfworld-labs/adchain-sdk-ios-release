...
class WebViewStackManager {
    ...
    func push(_ viewController: AdchainOfferwallViewController) {
        ...
        print("WebView pushed to stack. Stack size: \(webViewStack.count)")
    }
    ...
    func pop() -> AdchainOfferwallViewController? {
        ...
        if let weakRef = webViewStack.popLast() {
            print("WebView popped from stack. Remaining: \(webViewStack.count)")
    ...
    func closeAll() {
        ...
        print("Closing all WebViews. Stack size: \(webViewStack.count)")
    ...
    func remove(_ viewController: AdchainOfferwallViewController) {
        ...
        print("WebView removed from stack. Stack size: \(webViewStack.count)")
    }
